...
public class bookService {
    private static bookDao db = new bookDao();

    public static RetResult searchBook(String Bname) {
        ArrayList<book> books = db.searchBookByName(Bname);
        return new RetResult(200, books);
    }

    public static RetResult addBook(book Book) {
    ...
    public static RetResult deleteBook(book Book) {
    ...
    public static RetResult updateBook(book Book) {
